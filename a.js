...
function update ()
{
    ...
    this.input.on('pointerdown', function(pointer, x, y, event) {
        ...
        text.setText([
            `${pointer.x}, ${pointer.y}`
            // `pointer1.isDown:  ${this.input.pointer1.isDown}, ${this.input.pointer1.x} ${this.input.pointer1.y}`,
            // `pointer2.isDown:  ${this.input.pointer2.isDown}, ${this.input.pointer2.x} ${this.input.pointer2.y}`,
            // `pointer3.isDown:  ${this.input.pointer3.isDown}, ${this.input.pointer3.x} ${this.input.pointer3.y}`,
            // `pointer4.isDown:  ${this.input.pointer4.isDown}, ${this.input.pointer4.x} ${this.input.pointer4.y}`
        ]);
